...
@section('title', 'Créer un groupe - Gestion Événements')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Créer un groupe</h1>
        </div>
    </div>
    ...
    <form action="{{ route('team.groups.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" 
                                ...
                                <option value="committee" {{ old('type') === 'committee' ? 'selected' : '' }}>Comité</option>
                                <option value="unit" {{ old('type') === 'unit' ? 'selected' : '' }}>Unité</option>
                            </select>
                            @error('type')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border rounded p-2" style="max-height: 250px; overflow-y: auto;">
                                <div id="userList">
                                    ...
                                    <div class="form-check user-item" data-name="{{ strtolower($user->full_name) }}" data-email="{{ strtolower($user->email) }}">
                                        <input class="form-check-input member-checkbox" type="checkbox" name="member_ids[]" value="{{ $user->id }}" id="user_{{ $user->id }}">
                            ...
                            <small class="text-muted" id="selectedCount">0 membre(s) sélectionné(s)</small>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-2"></i>Créer le groupe
                            </button>
